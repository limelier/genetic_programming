...
The idea behind the thesis was constructed collaboratively with my guiding professor, Assist. dr. Croitoru Eugen. The Rust source code for the training environment and the Python code for the two helper scripts were written by me. Screenshots are taken by me in Minecraft\cite{minecraft} using CC: Tweaked\cite{cctweaked}, a fork of ComputerCraft\cite{computercraft}. Diagrams are made by me using {draw.io}. Test running, result collection and analysis are all my own work as well.
