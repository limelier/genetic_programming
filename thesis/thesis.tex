...
When mutating a tree is required, it is possible to change out a node for one of the same arity, or even for a completely new sub-tree, and still have a functioning program.

\begin{figure}[h]
    \centering
    \includegraphics{tree_2}
