...
pub(crate) const INDIVIDUALS_PER_METHOD_AND_DEPTH: usize = 20;
pub(crate) const MIN_GEN_DEPTH: usize = 2;
pub(crate) const MAX_GEN_DEPTH: usize = 6;
pub(crate) const POPULATION_SIZE: usize = (MAX_GEN_DEPTH - MIN_GEN_DEPTH + 1) * INDIVIDUALS_PER_METHOD_AND_DEPTH;
pub(crate) const MAX_PROGRAM_RUNTIME_MS: u128 = 100;
pub(crate) const GEN_COUNT: usize = 1000;
pub(crate) const CROSSOVER_SIZE: usize = POPULATION_SIZE * 4 / 5;
